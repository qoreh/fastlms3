...
public class AdminBannerController extends BaseController {
    ...
    public String add(Model model, BannerInput parameter,
        ...
        model.addAttribute("openOptions", OpenOption.values());

        return "admin/banner/add";
    }

    private String[] getNewSaveFile(String baseLocalPath,
                                    String baseUrlPath, String originalFilename) {
    ...
    public String addSubmit(Model model, HttpServletRequest request
        ...
        if (file != null) {
            ...
            String baseLocalPath =
                    "/Users/sukyungyang/Desktop/ZB_JAVA/과제/fastlms3/src/main/resources/static/files";
        ...
        parameter.setPublic(request.getParameter("isPublic") != null);
